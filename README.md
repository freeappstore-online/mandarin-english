...
The CLI clones this template, replaces every `mandarin-english` placeholder with your app id, runs `git init`, and makes the first commit — the result is a runnable app you can `pnpm dev` immediately.
...
cd my-app
# Replace mandarin-english → my-app in package.json, web/index.html, web/src/main.tsx, README, etc.
rm -rf .git && git init
